...
CONTENT_TYPE_MAPPER = {
    ...
    "circuits.providers": None,
    "circuits.provideraccounts": None,
    "circuits.providernetworks": None,
    "circuits.circuittypes": None,
    "circuits.circuitgroups": None,
    "circuits.circuitgroupassignments": None,

    "core.datasources": None,
    "core.datafiles": None,
    "core.jobs": None,
    "core.objectchanges": None,

    "dcim.cable": Cables,
    "dcim.cablepath": None,
    "dcim.cabletermination": Termination,
    "dcim.connecteddevice": None,
    ...
    "dcim.virtualdevicecontext": None,

    "extras.bookmark": None,
    "extras.configcontext": None,
    "extras.configrevision": None,
    "extras.configtemplate": None,
    "extras.customfield": None,
    "extras.customfieldchoiceset": None,
    "extras.customlink": None,
    "extras.eventrule": None,
    "extras.exporttemplate": None,
    "extras.imageattachment": None,
    "extras.jobresult": None,
    "extras.journalentry": None,
    "extras.notification": None,
    "extras.notificationgroup": None,
    "extras.objectchange": None,
    "extras.objecttype": None,
    "extras.report": None,
    "extras.savedfilter": None,
    "extras.script": None,
    "extras.subscription": None,
    "extras.tag": None,
    ...
    "virtualization.virtualdisk": None,
    ...
    "vpn.ikepolicie": None,
    "vpn.ikeproposal": None,
    "vpn.ipsecpolicie": None,
    "vpn.ipsecproposal": None,
    "vpn.ipsecprofile": None,
    "vpn.tunnelgroup": None,
    "vpn.tunnel": None,
    "vpn.tunneltermination": None,
    "vpn.l2vpn": None,
    "vpn.l2vpntermination": None,
}
